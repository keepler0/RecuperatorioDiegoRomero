...
namespace Neptuno2023.Windows
{
    public partial class FrmProductosAE : Form
    {
        ...
        {
            IServiciosProveedores servicio = new ServiciosProveedores();
            FrmProveedoresAE frm = new FrmProveedoresAE() { Text = "Agregar nuevo proveedor" };
            ...
            messageBoxHelper.Information("Se ha agregado nuevo proveedor", "Agregado");
            CombosHelper.CargarComboProveedores(ref cboProveedores);
